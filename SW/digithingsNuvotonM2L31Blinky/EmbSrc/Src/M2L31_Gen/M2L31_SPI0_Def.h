// Base Addres of SPI0 = 0x40061000

#define M2L31_SPI0_SPIx_CTL_RESET_VALUE 0x00000034
typedef struct {
...
} sM2L31_SPI0_SPIx_CTL;

typedef union {
    sM2L31_SPI0_SPIx_CTL Bit;
    unsigned long  All;
} uM2L31_SPI0_SPIx_CTL;

#define M2L31_SPI0_SPIx_CLKDIV_RESET_VALUE 0x00000000
typedef struct {
    unsigned long DIVIDER : 9;
    unsigned long Res0 : 23;
} sM2L31_SPI0_SPIx_CLKDIV;

typedef union {
    sM2L31_SPI0_SPIx_CLKDIV Bit;
    unsigned long  All;
} uM2L31_SPI0_SPIx_CLKDIV;

#define M2L31_SPI0_SPIx_SSCTL_RESET_VALUE 0x00000000
typedef struct {
    unsigned long SS : 1;
    unsigned long Res0 : 1;
...
} sM2L31_SPI0_SPIx_SSCTL;

typedef union {
    sM2L31_SPI0_SPIx_SSCTL Bit;
    unsigned long  All;
} uM2L31_SPI0_SPIx_SSCTL;

#define M2L31_SPI0_SPIx_PDMACTL_RESET_VALUE 0x00000000
typedef struct {
    unsigned long TXPDMAEN : 1;
    unsigned long RXPDMAEN : 1;
    unsigned long PDMARST : 1;
    unsigned long Res0 : 29;
} sM2L31_SPI0_SPIx_PDMACTL;

typedef union {
    sM2L31_SPI0_SPIx_PDMACTL Bit;
    unsigned long  All;
} uM2L31_SPI0_SPIx_PDMACTL;

#define M2L31_SPI0_SPIx_FIFOCTL_RESET_VALUE 0x22000000
typedef struct {
...
} sM2L31_SPI0_SPIx_FIFOCTL;

typedef union {
    sM2L31_SPI0_SPIx_FIFOCTL Bit;
    unsigned long  All;
} uM2L31_SPI0_SPIx_FIFOCTL;

#define M2L31_SPI0_SPIx_STATUS_RESET_VALUE 0x00050110
typedef struct {
...
} sM2L31_SPI0_SPIx_STATUS;

typedef union {
    sM2L31_SPI0_SPIx_STATUS Bit;
    unsigned long  All;
} uM2L31_SPI0_SPIx_STATUS;

#define M2L31_SPI0_SPIx_STATUS2_RESET_VALUE 0x00000000
typedef struct {
    unsigned long Res0 : 24;
    unsigned long SLVBENUM : 6;
    unsigned long Res1 : 2;
} sM2L31_SPI0_SPIx_STATUS2;

typedef union {
    sM2L31_SPI0_SPIx_STATUS2 Bit;
    unsigned long  All;
} uM2L31_SPI0_SPIx_STATUS2;

#define M2L31_SPI0_SPIx_TX_RESET_VALUE 0x00000000
typedef struct {
    unsigned long TX : 32;
} sM2L31_SPI0_SPIx_TX;

typedef union {
    sM2L31_SPI0_SPIx_TX Bit;
    unsigned long  All;
} uM2L31_SPI0_SPIx_TX;

#define M2L31_SPI0_SPIx_RX_RESET_VALUE 0x00000000
typedef struct {
    unsigned long RX : 32;
} sM2L31_SPI0_SPIx_RX;

typedef union {
    sM2L31_SPI0_SPIx_RX Bit;
    unsigned long  All;
} uM2L31_SPI0_SPIx_RX;

#define M2L31_SPI0_SPIx_I2SCTL_RESET_VALUE 0x00000000
typedef struct {
...
} sM2L31_SPI0_SPIx_I2SCTL;

typedef union {
    sM2L31_SPI0_SPIx_I2SCTL Bit;
    unsigned long  All;
} uM2L31_SPI0_SPIx_I2SCTL;

#define M2L31_SPI0_SPIx_I2SCLK_RESET_VALUE 0x00000000
typedef struct {
...
} sM2L31_SPI0_SPIx_I2SCLK;

typedef union {
    sM2L31_SPI0_SPIx_I2SCLK Bit;
    unsigned long  All;
} uM2L31_SPI0_SPIx_I2SCLK;

#define M2L31_SPI0_SPIx_I2SSTS_RESET_VALUE 0x00050100
typedef struct {
...
} sM2L31_SPI0_SPIx_I2SSTS;

typedef union {
    sM2L31_SPI0_SPIx_I2SSTS Bit;
    unsigned long  All;
} uM2L31_SPI0_SPIx_I2SSTS;

typedef struct {
    uM2L31_SPI0_SPIx_CTL M2L31_SPI0_SPIx_CTL; // Offset: 0x0
    uM2L31_SPI0_SPIx_CLKDIV M2L31_SPI0_SPIx_CLKDIV; // Offset: 0x4
    uM2L31_SPI0_SPIx_SSCTL M2L31_SPI0_SPIx_SSCTL; // Offset: 0x8
    uM2L31_SPI0_SPIx_PDMACTL M2L31_SPI0_SPIx_PDMACTL; // Offset: 0xc
    uM2L31_SPI0_SPIx_FIFOCTL M2L31_SPI0_SPIx_FIFOCTL; // Offset: 0x10
    uM2L31_SPI0_SPIx_STATUS M2L31_SPI0_SPIx_STATUS; // Offset: 0x14
    uM2L31_SPI0_SPIx_STATUS2 M2L31_SPI0_SPIx_STATUS2; // Offset: 0x18
    unsigned long Reserved0;
    uM2L31_SPI0_SPIx_TX M2L31_SPI0_SPIx_TX; // Offset: 0x20
    unsigned long Reserved1;
    unsigned long Reserved2;
    unsigned long Reserved3;
    uM2L31_SPI0_SPIx_RX M2L31_SPI0_SPIx_RX; // Offset: 0x30
    ...
    uM2L31_SPI0_SPIx_I2SCTL M2L31_SPI0_SPIx_I2SCTL; // Offset: 0x60
    uM2L31_SPI0_SPIx_I2SCLK M2L31_SPI0_SPIx_I2SCLK; // Offset: 0x64
    uM2L31_SPI0_SPIx_I2SSTS M2L31_SPI0_SPIx_I2SSTS; // Offset: 0x68
} sM2L31_SPI0;
